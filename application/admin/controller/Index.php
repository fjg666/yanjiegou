...
class Index extends Common
{
    ...
    public function main(){
        ...
        $data['tody']['goods1']  = Db::name('goods')->where("shop_id", $shopid)->where(['createtime'=>['between',[$start,$end]],'check_status'=>1,'status'=>1])->count();
        $data['tody']['goods0']  = Db::name('goods')->where("shop_id", $shopid)->where(['createtime'=>['between',[$start,$end]],'check_status'=>0])->count();
